# 育児系Threadsアカウント運用プロジェクト

Threads「ラクして楽しむパパ育児(@papa_rakuiku)」をバズらせ、フォロワーを伸ばすための運用ドキュメント一式です。
一人運用を前提にしています。
...
| ファイル | 内容 |
|---|---|
| [strategy/01_account_strategy.md](strategy/01_account_strategy.md) | アカウントコンセプト・ターゲット・トーン設計・プロフィール文 |
| [strategy/02_role_division.md](strategy/02_role_division.md) | 一人運用の工程フロー(企画→執筆→投稿→振り返り) |
| [strategy/03_content_calendar.md](strategy/03_content_calendar.md) | 投稿カレンダーと週次サイクル |
